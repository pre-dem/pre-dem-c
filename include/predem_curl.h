...
app_name,    app 名称，可选
app_version, app 版本，可选
device_model, 机型，可选
manufacturer,  制造商，可选
device_id,     设备id，可选，和sdk_id尽量要有一个配置好，便于后期查找终端

os_platform,  操作系统，可选
os_version,   操作系统版本，可选

sdk_id,  每个设备上的app id，建议生成文件存下来，下次读取
tag  关联的自定义标志，下次读取 比如app 用户id, 可选
*/

void predem_curl_set_env(
